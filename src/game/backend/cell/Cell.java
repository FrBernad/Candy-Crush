...
public class Cell {
    ...
    public void setAround(Cell up, Cell down, Cell left, Cell right) { //SETTE LAS CELDAS ALREDEDOR DE UNA
    ...
    public void clearContent() {
        if (content.isMovable()) {
            if (content instanceof NumberedCandy) {//MARCA AL CARAMELO ELIMINADO
                ((NumberedCandy) content).killCandy();
            }
